...
public class CardsController : ControllerBase
{
    ...
    /// Use "USD" or "United States-Dollar" to receive the balance in its stored base currency.
    /// </summary>
    [HttpGet("{cardId:guid}/balance")]
    [ProducesResponseType(typeof(BalanceResponse), StatusCodes.Status200OK)]
    [ProducesResponseType(StatusCodes.Status404NotFound)]
    [ProducesResponseType(StatusCodes.Status422UnprocessableEntity)]
    public async Task<IActionResult> GetBalance(Guid cardId, [FromQuery] string currency = "United States-Dollar")
    {
        try
        {
