...
public class TransactionsController : ControllerBase
{
    ...
    /// Amount is stored in USD (the base currency of the Treasury FX API).
    /// </summary>
    [HttpPost]
    ...
    /// Specify currency as Treasury API country_currency_desc (e.g. "Australia-Dollar").
    /// </summary>
    [HttpGet("{transactionId:guid}")]
    [ProducesResponseType(typeof(ConvertedTransactionResponse), StatusCodes.Status200OK)]
    [ProducesResponseType(StatusCodes.Status404NotFound)]
    [ProducesResponseType(StatusCodes.Status422UnprocessableEntity)]
    public async Task<IActionResult> GetTransaction(Guid cardId, Guid transactionId, [FromQuery] string currency = "United States-Dollar")
    {
        try
        {
